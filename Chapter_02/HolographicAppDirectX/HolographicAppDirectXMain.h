...
namespace HolographicAppDirectX
{
    class HolographicAppDirectXMain : public DX::IDeviceNotify
    {
    public:
        HolographicAppDirectXMain(const std::shared_ptr<DX::DeviceResources>& deviceResources);
        ~HolographicAppDirectXMain();
