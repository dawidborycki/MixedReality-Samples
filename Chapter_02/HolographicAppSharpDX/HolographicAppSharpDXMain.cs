...
using HolographicAppSharpDX.Common;
using System.Threading.Tasks;
using Windows.Foundation;
using System.Collections.Generic;

#if DRAW_SAMPLE_CONTENT
using HolographicAppSharpDX.Content;
#endif

namespace HolographicAppSharpDX
{
    /// <summary>
    /// Updates, renders, and presents holographic content using Direct3D.
    /// </summary>
    internal class HolographicAppSharpDXMain : IDisposable
    {
        ...
        public HolographicAppSharpDXMain(DeviceResources deviceResources)
        {
